  ...
  ?>
   <script>
  	$(document).ready(function() {
  		...
  		$("#Network Operation & Maintenance  a:contains('ข้อมูล ณ วันที่ 04-05-2017')").parent().addClass('active');
  	});
...
?>
				...
				<div class="alert alert-info">
						...
						<h2>ทีม Network Operation & Maintenance</h2>
